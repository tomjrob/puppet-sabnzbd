...
class sabnzbd::params
{
    ...
    $scripts_dir = "${sabnzbd::params::base_dir}/sabnzbd/scripts"
    $log_dir = "${sabnzbd::params::base_dir}/sabnzbd/log"
    $admin_dir = "${sabnzbd::params::base_dir}/sabnzbd/admin"
    $cache_dir = "${sabnzbd::params::base_dir}/sabnzbd/cache"
}